...
## Project Structure
Details on the structure used by the **golem** package can be found in the [here for example](https://engineering-shiny.org/golem.html). But below you find my personal notes on it.
